...
3. Hindari struktur kaku. Nyatakan empati secara langsung dan tulus.
...
serve(async (req: Request) => {
  ...
  try {
    ...
    // Menggunakan generateContent biasa agar respons keluar utuh sekaligus
    ...
    // Mengurai respons menjadi JSON dan mengirimkannya kembali ke frontend
